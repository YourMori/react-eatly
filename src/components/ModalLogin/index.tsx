...
const ModalLogin: React.FC<ModalLoginProps> = ({ active, setActive }) => {
	return (
				...
				<div className={styles.modal__login}>
					<div className={styles.modal__content}>
						...
						<form action='#' className={styles.modal__form}>
							<h2 className={styles.modal__form__title}>Sign in to Eatly</h2>
							...
							<div className={styles.modal__form__login}>
								<input type='email' className={styles.modal__form__login_input} placeholder='Email'></input>
								...
								<button className='modal__form__login-button'>Sign in</button>
								<p className='modal__form__text'>
									Create A New Account?
									<a className='modal-link'> Sign up</a>
								</p>
							</div>
						</form>
